...
# knitr::include_app("http://54.170.29.71:3838/TeachingApp/", height = "800px")
```
...
knitr::include_app("http://54.170.29.71:3838/FF15-16/", height = "800px")
...
knitr::include_app("http://54.170.29.71:3838/DublinRTPI/", height = "800px")
...
[Example](https://github.com/aboland/footballR)
```{r , eval = F, echo = T}
...
## Sharing - [Docker](https://www.docker.com/)
